def get_config() -> dict:
    ...
    cfg["prompts"]["json_tool_prior_conversations"] = {
        ...
        "prompt": (
            ...
            "id: (int) Unique identifier for the communication entry. \n"
            "listingMapId: (int) Identifier linking the communication to a specific property listing.\n"
            "reservationId: (int) Identifier for the reservation related to the communication. \n"
            "conversationId: (int) Identifier for the conversation thread. \n"
            ...
            "listingTimeZoneName: (str) The time zone of the property listing.\n"
            "status: (str) The status of the communication (e.g., sent, received).\n"
            "sentChannelDate: (str) The date and time when the communication was sent. Ex: '2024-07-16 21:19:02'\n"
            "communicationType: (str) The type of communication (e.g., email, SMS).\n"
